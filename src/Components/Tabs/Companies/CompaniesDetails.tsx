        ...
        <>
         <div className="sm:w-[1000px] h-[500px] p-4 rounded-xl border-blue-300 border-[1px] m-auto mt-12 bg-gradient-to-tl from-sky-50 to-sky-100 shadow-xl">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-sky-900 pt-4">{comp.INS_COMPANY_NAME}</h1>
                    <div className="text-stone-600 font-light text-sm">{comp.INS_COMPANY_ADDR}</div>
                </div>
                <div className="flex gap-8 mt-6 w-[80%] m-auto justify-center">
                    <div className="flex gap-2">
                        <Phone className="text-sky-900"/>
                        <a href={"tel: " + comp.INS_COMPANY_TEL} className="underline">{comp.INS_COMPANY_TEL}</a>
                    </div>
                    <div className="flex gap-2">
                        <AlternateEmail className="text-sky-900"/>
                        <a href={"mailto: " + comp.INS_COMPANY_CONTACT} className="underline">{comp.INS_COMPANY_CONTACT}</a>
                    </div>
                    <div className="flex gap-2">
                        <AccountBalance className="text-sky-900"/>
                        <div>{comp.INS_COMPANY_BULSTAT}</div>
                    </div>
                </div>
